...
//	List<AnimatedGameObject> animatedObjects;
	public Controller(MazeScreen screen, String mapPath) {
		this.view = screen;
		this.model = new Level(this, mapPath);
...
//			obj.registerAnimationEndListener(s);
	...
	/***
	 * Called by {@link com.turpgames.maze.level.Controller.maze.controller.MazeController#waiting waiting}
	 * state to signal start of user input. Old rotation value is recorded. The
	 * next state ({@link com.turpgames.maze.level.Controller.maze.controller.MazeController#userRotating
	...
	/***
	 * Called by {@link com.turpgames.maze.level.Controller.maze.controller.MazeController#userRotating
	 ...
	 * {@link com.turpgames.maze.level.Controller.maze.controller.MazeController#waiting waiting} state.
	 */
	 ...
	 * next state, {@link com.turpgames.maze.level.Controller.maze.controller.MazeController#mazeRotating
	 * mazeRotating}.
	 * 
	 * @param userRotation
	 * @param userAngle
	...
	/***
	 * Called by {@link com.turpgames.maze.level.Controller.maze.controller.MazeController#mazeRotating
